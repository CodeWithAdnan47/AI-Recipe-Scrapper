    ...
    const features = [
        {
            ...
            description: 'Store all your favorite recipes in one secure place. Search, filter, and organize by category.',
            icon: (
        ...
        },
        {
            ...
            description: 'Import recipes from any URL with a single click. We automatically extract ingredients and instructions.',
            icon: (
                <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
            ),
        },
        {
            title: 'Internet Fallback',
            description: 'Access your saved recipes even when you are offline. Perfect for cooking in remote locations.',
            icon: (
